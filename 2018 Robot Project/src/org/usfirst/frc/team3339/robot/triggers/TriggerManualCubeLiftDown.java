 ...
 *
 */
public class TriggerManualCubeLiftDown extends Trigger {

	@Override
	public boolean get() {
		return OI.operatorController.getY(Hand.kLeft) >= 0.7 && Robot.m_cubeLift.isInState(CubeLiftState.MANUAL);
	}
}
